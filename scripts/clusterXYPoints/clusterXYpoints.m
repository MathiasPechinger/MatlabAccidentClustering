...
%
%% Code
function [clustersCentroids,clustersGeoMedians,clustersXY] = clusterXYpoints(inputData,maxdist,minClusterSize,method,mergeflag)
% Default variables
...
outputfile = 'Results/cluster_centroids.txt';
% write header line
...
outputfile = 'Results/cluster_geometric-medians.txt';
% write header line
fidout = fopen(outputfile,'w');
fprintf(fidout,'%s\t%s\n','X','Y');
fclose(fidout);
